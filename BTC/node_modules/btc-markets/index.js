...
{
    var params = {currency: currency,instrument: instrument,price: price,volume: volume,orderSide: orderSide,ordertype: ordertype,clientRequestId: clientRequestId};
...
BTCMarkets.prototype.withdrawCrypto = function withdrawCrypto(amount, address, cryptoNum, callback)
{
